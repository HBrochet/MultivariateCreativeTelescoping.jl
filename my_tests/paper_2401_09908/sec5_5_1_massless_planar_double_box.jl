...
# Section 5.5.1 of arXiv:2401.09908
# Massless planar double-box graph in D = 4 - 2*eps dimensions.
...
U = "((x1 + x2 + x3)*(x4 + x5 + x6) + x1 + x2 + x3 + x4 + x5 + x6)"
F = "(X*x3*x5 + (x1 + x2 + x3)*x4*x6 + (x4 + x5 + x6)*x1*x2 + (x2 + x4)*(x1 + x6))"
